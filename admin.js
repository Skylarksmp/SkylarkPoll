        ...
        async () => {
            ...
            const confirmed =
                confirm(
                    ...
                    "Every poll with CLOSED status " +
                    "will be permanently deleted.\n\n" +
                    "Active polls will NOT be affected.\n\n" +
            ...
            try {
                ...
                if (
                    ...
                    alert(
                        "There are no closed polls to delete."
                    );
                ...
                alert(
                    `Deleted ${closedPolls.length} closed poll(s).`
                );
